defmodule TutorialBaseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TutorialBaseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TutorialBaseWeb.Gettext, "errors", msg, opts)
    end
  end
